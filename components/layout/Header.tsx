        ...
        <div className="flex items-center gap-8">
          ...
          <details id="mobile-nav" className="md:hidden group">
            ...
            <div className="fixed left-0 right-0 top-[108px] z-40 bg-brand-black border-t border-white/10 px-6 pb-6 pt-4">
              <nav className="flex flex-col gap-4 mx-auto max-w-7xl items-end">
                <a
                  href="/"
                  onClick={(e) => {
                    handleHomeClick(e);
                  ...
                  className="text-xl font-medium text-brand-white/80 hover:text-brand-white"
                >
                  HOME
                </a>
                <Link
                ...
                <Link
                  href="/estimate"
                  onClick={() => (document.getElementById("mobile-nav") as HTMLDetailsElement | null)?.removeAttribute("open")}
                  className="mt-2 inline-flex h-12 items-center justify-center rounded-md bg-brand-yellow px-7 text-sm font-black tracking-widest text-brand-black"
                >
                  GET A FREE ESTIMATE
                </Link>
              </nav>
