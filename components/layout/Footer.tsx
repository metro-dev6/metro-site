...
const socialLinks = [
  {
    label: "Instagram",
    href: "https://instagram.com/metroautodetailingca",
    icon: (
  ...
  {
    label: "Facebook",
    href: "https://www.facebook.com/profile.php?id=61586613950253",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    label: "TikTok",
    href: "https://tiktok.com/@metroautodetailing",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
...
export function Footer() {
  return (
    <footer className="bg-zinc-950 border-t border-white/[0.06] px-6 lg:px-8 pt-14 pb-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 pb-10 border-b border-white/[0.06]">
          ...
          <div className="flex flex-col gap-4">
            ...
            <p className="text-xs font-bold tracking-[0.2em] uppercase text-brand-yellow">
              We Come to You. Driven by Detail.
            </p>
            <div className="flex flex-col gap-1.5 mt-1">
              ...
              <a
                href="mailto:metrodetailing661@gmail.com"
                className="text-sm text-brand-white/50 hover:text-brand-white transition-colors"
              >
                metrodetailing661@gmail.com
              </a>
            </div>
          </div>
